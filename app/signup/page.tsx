  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center">
      ...
      >
        ...
        {error && (
          <div className="mb-4 text-red-700 text-sm font-semibold text-center">{error}</div>
        )}
        {success && (
          <div className="mb-4 text-green-700 text-sm font-semibold text-center">{success}</div>
        )}
        <button
          type="submit"
          className="w-full bg-blue-700 hover:bg-blue-800 text-white font-semibold py-2 rounded transition-colors mt-2"
          disabled={loading}
        >
